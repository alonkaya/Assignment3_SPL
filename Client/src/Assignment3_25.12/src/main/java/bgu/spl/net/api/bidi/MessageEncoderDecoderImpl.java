...
public class MessageEncoderDecoderImpl implements MessageEncoderDecoder<Message> {
    ...
    public Message decodeNextByte(byte nextByte) {
        ...
        if(opcode == 1 && nextByte != ';') {
            ...
            if(nextByte != '\0'){
                ...
                if (((RegisterMessage)message).getUsername() == null) { //If we haven't decoded username yet, convert bytes to string
                    ...
                    String password = new String(messageBytes, StandardCharsets.UTF_8);
                    ...
                    String birthday = new String(messageBytes, StandardCharsets.UTF_8);
        ...
        ///////////////////////////////////////Login///////////////////////////////////////
            ...
            if (((LoginMessage)message).getUsername() != null && ((LoginMessage)message).getPassword() != null){
        ...
        ///////////////////////////////////////PM///////////////////////////////////////
            ...
            if(nextByte != '\0'){
                ...
                if (((PMMessage)message).getUsername() == null) { //If we haven't decoded username yet, convert bytes to string
                    ...
                    String time = new String(messageBytes, StandardCharsets.UTF_8);
...
//        }//////////////////////////////////////////////////Block///////////////////////////////////////
    ...
    public byte[] encode(Message message) {
        ...
        String messageString = String.valueOf(opcode);
        ...
        if(opcode == 9){
            ...
            messageString += notificationType + postingUser + '\0' + content + '\0';
        }
        ///////////////////////////////////////Ack///////////////////////////////////////
        else if(opcode == 10){
            short messageOpcode = ((AckMessage)message).getMessageOpcode();
            ...
            if (messageOpcode == 4) {//Follow
                messageString +=  ((AckMessage)message).getUsername();
            }
            else{//Stat/Logstat
